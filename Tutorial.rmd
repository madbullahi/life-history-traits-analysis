...
SynAdd <- read_excel("Add.xlsx")
SynAdd$treatment <- factor(SynAdd$treatment, levels = c("HA", "LA", "HC", "LC", "HALC","HAHC", "LALC","LAHC","HALCNull","HAHCNull","LALCNull","LAHCNull"))
SynAdd$pop <- factor(SynAdd$pop, levels = c("CWP","PP","EP"))
SynAdd$trait <- factor(SynAdd$trait, levels = c("sumNeoNpop","sizeNpop","adultNpop"))
ggplot(SynAdd, aes(x=treatment, y=mean, fill=pop)) + 
