...
SynAdd$treatment <- factor(SynAdd$treatment, levels = c("MP", "PFOS", "PFOA", "MP_PFOA", "PFOS_PFOA","MP_PFOS_PFOA", "MP_PFOANULL","PFOS_PFOANULL","MP_PFOSNULL","MP_PFOS_PFOANULL"))

SynAdd$Genotypes <- factor(SynAdd$Genotypes, levels = c("LRV-0-1","LR2-36-01"))
...
theme(panel.grid.major=element_blank(),panel.grid.minor=element_blank())+
  scale_fill_manual(values=c("black", "grey", "pink", "red")) 
```
